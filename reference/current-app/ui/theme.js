...
const baseTheme = {
  colors: {
    ...
    // =========================
    neutral: {
      100: "#F5F5F5", // Lightest - subtle backgrounds
      ...
      700: "#404040", // Darker - subheadings
      800: "#262626", // Near black - headings
      900: "#171717", // Darkest - primary text
    },

    // =========================
    // ORANGE — Fire/Flame (warm)
    // =========================
    orange: {
      pale: "#FFEDD5", // Light backgrounds
      light: "#FDBA74", // Highlights, hover
      DEFAULT: "#F97316", // Primary orange
      deep: "#C2410C", // Pressed states
      dark: "#7C2D12", // Dark accents
    },

    // =========================
    // YELLOW — Fire/Flame (spark)
    // =========================
    yellow: {
      pale: "#FEF9C3", // Light backgrounds
      light: "#FDE047", // Highlights
      DEFAULT: "#FACC15", // Primary yellow (Spark)
      deep: "#CA8A04", // Pressed states
      dark: "#713F12", // Dark accents
    },
    ...
    red: {
      ...
      deep: "#B91C1C", // Pressed states
      dark: "#7F1D1D", // Dark accents
    },
    ...
    purple: {
      ...
      deep: "#5B21B6", // Buttons, accents
      dark: "#2E1065", // Dark mode bg
    },
    ...
    blue: {
      ...
      deep: "#1D4ED8", // Buttons, accents
      dark: "#1E3A8A", // Dark mode bg
    },
